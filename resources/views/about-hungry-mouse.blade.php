...
@section('content')
      ...
      <section class="py-8 overflow-hidden bg-hungry-green" id="about-brand">
        <div class="container-fluid px-0">
          <div class="row flex-center">
            <div class="col-12 text-center">
              <h1 class="display-1 fs-md-5 fs-lg-6 fs-xl-8 text-white fw-bolder mb-4">About Hungry Mouse</h1>
              <p class="lead text-white mb-5">The best cloud kitchen in Lucknow.</p>
            </div>
          </div>
          <div class="row justify-content-center">
            <div class="col-md-8 mt-4"><img class="img-fluid rounded-3 w-100" src="{{ asset(\'assets/img/gallery/truck.jpeg\') }}" alt="Hungry Mouse Truck" style="box-shadow: 0 10px 40px rgba(0,0,0,0.3);"></div>
          </div>
        </div>
      </section>
