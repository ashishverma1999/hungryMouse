...
# Inject into public/menu.html
with open('public/menu.html', 'r', encoding='utf-8') as f:
    file_content = f.read()

# find injection point
injection_point = file_content.find('<!-- <section> begin ============================-->')

if injection_point != -1:
    new_content = file_content[:injection_point] + html + '\n' + file_content[injection_point:]
    with open('public/menu.html', 'w', encoding='utf-8') as f:
        f.write(new_content)
    print("Menu generated successfully in public/menu.html!")
else:
